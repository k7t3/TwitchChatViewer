...
public class MergedChatDataCell extends TextFlow implements Cell<ChatDataViewModel, TextFlow> {
    ...
    private static final String STYLE_CLASS = "merged-chat-data-view";
    private static final String IMAGE_STYLE_VIEW = "merged-chat-image-view";
    private static final String NAME_STYLE_CLASS = "merged-chat-name-label";
    private static final String CHAT_STYLE_CLASS = "merged-chat-text";
    ...
    public MergedChatDataCell(ChatDataViewModel viewModel) {
    ...
    public void initialize() {
        ...
        if (!viewModel.getChatData().isSystemMessage()) {
            ...
            getChildren().addAll(userNameText);
